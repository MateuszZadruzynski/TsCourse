...
let noTwo: number; //<-- jeżeli zmienna jest zainicjowana ale bez wartości, możemy określić jej typ
const showResult = true;
const prefix = "Wynik dodawania";

function Add(variableOne:number, variableTwo:number, passResult:boolean, prefix:string)
{
    if(passResult)
    {
